 ...
 * Change Log :
 * v1.2_patched
 *    - left margin was always present making it impossible to center the menu. Removed the left margin 
 * v1.2
...
if(!$.fn.jqDock){ //can't see why it should be, but it doesn't hurt to check
  ...
  */
	  ...
	  // v1.2_patched - Calculate the size of the margin when menu at rest
	  this.alignAdjustment = (Dock[op.vh.wh] - Dock.Spread) / 2;
  ...
  */
      ...
      //===========================================
	    ...
	    // v1.2_patched Added subtraction to remove left margin	    
            Dock.Yard.css('margin'+op.vh.lead, Math.floor(Math.max(0, (Dock[op.vh.wh] - Dock.Spread) / 2)-this.alignAdjustment));
