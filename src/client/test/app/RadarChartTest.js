/**
 * A test class for the echopoint.google.chart.RadarChart client-side component.
 * Displays simple and multi value charts to test Google Chart API interaction.
 *
 * @author Rakesh 2008-08-24
 * @version $Id: RadarChartTest.js,v 1.1.1.1 2010-04-01 09:47:34 perxi Exp $
 */
echopoint.test.RadarChartTest = Core.extend(
{
  ...
  _createStraight: function()
  {
    ...
    return new echopoint.google.chart.RadarChart(
    {
