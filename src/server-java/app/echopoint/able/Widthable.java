...
/**
 * A <code>Sizeable</code> is a component that can have a a fixed width 
...
public interface Widthable  extends Delegateable {
    ...
    /**
     * Returns the width extent of the <code>Widthable</code>.
     * @return the width extent of the <code>Widthable</code>.
     */
    public Extent getWidth();
    
	/**
	 * Sets the width extent of the <code>Widthable</code>.
	 * 
