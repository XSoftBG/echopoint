...
public abstract class AbstractTemplateDataSource implements TemplateDataSource, Serializable {
	...
	/**
	 * @see echopoint.template.TemplateDataSource#getCharacterEncoding()
	 */
	...
	/**
	 * @see echopoint.template.TemplateDataSource#getCachingHints()
	 */
	...
	/**
	 * @see echopoint.template.TemplateDataSource#getContentType()
	 */
	...
	/**
	 * @see echopoint.template.TemplateDataSource#getCompilerHints()
	 */
