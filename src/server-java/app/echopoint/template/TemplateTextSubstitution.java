...
/**
 * This interface is used substitue named "text tags" in the 
 * template markup with  variable Strings.
 * <p>
 * A single <code>TemplateTextSubstitution</code> can be used by more than
 * one <code>TemplatePanel</code>.  This helps reduce the memory footprint
...
public interface TemplateTextSubstitution extends Serializable {
	 ...
	 * given substitution name.  If the name is unknown, then
