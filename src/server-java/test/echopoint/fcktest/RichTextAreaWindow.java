 ...
 * @version $Id: RichTextAreaWindow.java,v 1.1.1.1 2010-04-01 09:47:30 perxi Exp $
 */
...
public class RichTextAreaWindow extends ATestWindow {

	Fckeditor rtaArea = new Fckeditor();
	TextArea textArea = new TextArea();

	public RichTextAreaWindow(String fckURL)
        {
		super("RichTextArea 400px X 100%width (powered by FCKEditor) "+Fckeditor.Version, new Extent(675),
				new Extent(675));
