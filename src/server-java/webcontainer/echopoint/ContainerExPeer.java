 ...
 * @version $Id: ContainerExPeer.java,v 1.1.1.1 2010-04-01 09:47:33 perxi Exp $
 */
public class ContainerExPeer extends AbstractPeer {


    /** The component name for which this class is a peer. */
    private static final String COMPONENT_NAME = ContainerEx.class.getName();


    /** The JS service files to load. */
    private static final String[] SERVICE_FILES =
            {
                    "resource/js/Application.ContainerEx.js",
                    "resource/js/Sync.ContainerEx.js"
            };
