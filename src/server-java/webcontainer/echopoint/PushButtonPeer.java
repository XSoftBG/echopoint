 ...
 * @version $Id: PushButtonPeer.java,v 1.1.1.1 2010-04-01 09:47:33 perxi Exp $
 */
public class PushButtonPeer extends AbstractContainerPeer
{
  /** The component name for which this class is a peer. */
  private static final String COMPONENT_NAME = PushButton.class.getName();

  /** The JS service files to load. */
  private static final String[] SERVICE_FILES =
      {
          "resource/js/Application.PushButton.js",
          "resource/js/Sync.PushButton.js"
      };
  ...
  /** Create a new instance and register a event peer. */
